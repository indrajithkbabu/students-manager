...
var photo;
  ...
  Widget build(BuildContext context) {
   ...
   if(_nameController.text.isEmpty) {_nameController.text =widget.data.name;
                   ...
                   backgroundColor: Colors.transparent,
                    child: ClipOval(
                      child: photo==null?  Image.asset('assets/defaultpic.jpg' ,fit: BoxFit.cover,height: 135,
                        width: 135,) :Image.file(File(widget.data.img) , fit: BoxFit.cover,height: 135,
                        width: 135,)
                    )),
...
final _name =_nameController.text.trim();
    ...
    //snackbar
    if (_name.isEmpty || _age.isEmpty || _branch.isEmpty || _phone.isEmpty ) {
